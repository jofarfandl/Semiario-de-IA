...
a_1 = 0.35;%tamaño de los brazos
a_2 = 0.35;
a_3 = 0.25;

pd = [-0.5; -0.5];%posicion destino

beta = 1000;
xl = [-160 -130 -100]'*(pi/180);
xu = [160 130 100]'*(pi/180);

%pocision actual del brazo
...
%funcion objetivo sumatoria de los errores al cuadrado
f = @(q) (1/4)*sum((pd-p(q(1),q(2),q(3))).^2);

%funcion original + termino de penalizacion
...
for i=1:N
    ...
    q = x(:,i);%optimizamos el q para llegar al resultado deseado
